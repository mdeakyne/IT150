...
print "Problem 1--------------Assigning Strings------------------------"
...
print "Problem 2-------Reading Indexes-----------------------"
...
print "Problem 3----------Ussing string functions---------------------------"
#Use len, upper, lower, and str to pass the assert statements
len_name = "Matthew Deakyne" #replace with your name first
upp_quote = "i have no idea what we are yelling about"
low_quote = "WE MUST USE OUR INDOOR VOICES"
str_check = 4582 #Do not just add quotes
...
print "Problem 4------------Adding strings together -----------------"
...
correct_order = a + b + c #use the variable names and add the strings together

print correct_order


print "Problem 5---------------User Input------------------------"
...
print "The assignment is complete, please turn it in on eSpire"
