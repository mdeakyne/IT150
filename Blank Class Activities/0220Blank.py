...
print "MAKE SURE TO PRINT OUT EVERY FUNCTION IN D APPLIED TO A, B"
print "DO THIS BEFORE STARTING PROBLEM 4"
...
else that item is normal price
...
print "All problems completed without error, you may now submit your assignment"