...
assert(f_add(5,7) == 0), "Your add assert is wrong"
assert(f_sub(10,18) == 0), "Your sub assert is wrong"
assert(f_div(18,5) == 0), "Your div assert is wrong"
assert(f_mod(18,5) == 0), "Your mod assert is wrong"
assert(f_exp(2,3) == 0), "Your exp assert is wrong"
...
def calculator(a,b,operation):
    if True: #fill this in with correct condition:
        pass
    elif True:
        pass
    elif True:
